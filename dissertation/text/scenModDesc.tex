...
Sections~\ref{sec:target_model}, \ref{sec:uav_model}, and \ref{sec:sensor_wpn_models} describe the rules and capabilities of the simulation.  The simulation is meant to be an approximation of the physical world to use as a test area for developing new control algorithms for swarms of UAVs.  The simulation is a custom software application created explicitly for this dissertation.  Section~\ref{sec:myModel} describes a new UAV swarm control algorithm to satisfy the goals of the research.
