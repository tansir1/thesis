...
\todo{Should detect vs confirm be described here or in UAV models?}
...
\todo{Show image of sensor footprint over grid}

\todo{chance of misclassification}
\todo{Chance of empty cell detection}
