...
\label{sec:myModel}
The other sections in this chapter described the rules and capabilities of the simulated worlds and the entities within.  These simulated worlds provide a virtual sandbox for developing new control algorithms for swarms of UAVs.  This section describes a new control algorithm developed for this dissertation by using these simulated worlds. 
