...
%	\includegraphics[width=5in,height=4in,keepaspectratio=false]{destroyed.png}
	\includegraphics[width=\linewidth,height=4in,keepaspectratio=false]{destroyed.png}
...
\begin{figure}[H]
	\centering
	%\includegraphics[width=\linewidth,height=\textheight]{imagefile}
	\includegraphics[width=\linewidth,height=4in,keepaspectratio=false]{detected.png}
...
\begin{figure}[H]
	\centering
	%\includegraphics[width=\linewidth,height=\textheight]{imagefile}
	\includegraphics[width=\linewidth,height=4in,keepaspectratio=false]{world_known.png}
