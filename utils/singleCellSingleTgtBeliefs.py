...
plt.plot(frames, emptyCellProbs, label='Empty Cell Prob', linestyle="-.", linewidth=plotLineWidth)
plt.plot(frames, notEmptyCellProbs, label='Not Empty Cell Prob', linestyle="-", linewidth=plotLineWidth)
axes = plt.gca()
