...
public class Angle
{
    ...
    * @return The cosine of the current angle value.
    */
   public double cosNorthUp()
   {
      return Math.cos(Math.toRadians(angleDeg + 90));
   }
   ...
   /**
    * Get the sine of the angle after adjusting the 0 value as being straight
    * up to north.
    *
    * @return The cosine of the current angle value.
    */
   public double sinNorthUp()
   {
      return Math.sin(Math.toRadians(angleDeg + 90));
   }
